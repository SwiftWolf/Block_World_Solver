...
public class Board {
	...
	public Board(int size, Point aStart, Point bStart, Point cStart, Point aGoal, Point bGoal, Point cGoal) {
		this.size = size;
		this.aStart = aStart;
		this.bStart = bStart;
		this.cStart = cStart;
	...
	public List<Board> expand(Boolean random) { 
		List<Board> expanded = new ArrayList<Board>();
	...
	public Board copyState() {
		Board copyBoard = new Board(this.size, this.aStart,this.bStart,this.cStart, this.aGoal,this.bGoal, this.cGoal);
		for (int i = 0; i < size; i++) {
			for (int j = 0; j < size; j++) {
